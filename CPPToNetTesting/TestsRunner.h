...
public:
	...
	Hummus::EStatusCode RunAll();
	Hummus::EStatusCode RunTest(const string& inTestLabel);
	Hummus::EStatusCode RunTests(const StringList& inTestsLabels);
	Hummus::EStatusCode RunCategory(const string& inCategory);
	Hummus::EStatusCode RunCategories(const StringList& inCategories);
	Hummus::EStatusCode RunCategories(const StringList& inCategories, const StringSet& inTestsToExclude);
	Hummus::EStatusCode RunExcludeCategories(const StringSet& inCategories);
	Hummus::EStatusCode RunExcludeTests(const StringSet& inTests);
...
private:
	...
	Hummus::EStatusCode RunTestsInList(const StringAndTestUnitList& inTests);
	Hummus::EStatusCode RunSingleTest(const string& inTestName,ITestUnit* inTest);
	void DeleteTests();
};
