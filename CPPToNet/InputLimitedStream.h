...
namespace Hummus
{
	...
	public:
		...
		InputLimitedStream(IByteReader* inSourceStream,LongFilePositionType inReadLimit,bool inOwnsStream);

		void Assign(IByteReader* inSourceStream,LongFilePositionType inReadLimit,bool inOwnsStream);
	...
	private:
		...
		bool mOwnsStream;
		IByteReader* mStream;
		LongFilePositionType mMoreToRead;
	};
