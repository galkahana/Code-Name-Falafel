...
#define DEFAULT_BUFFER_SIZE 256*1024
	...
	public:
		...
		*/
		OutputBufferedStream(LongBufferSizeType inBufferSize);

		/*
			Constructor with assigning. see Assign for unassign instructions
		*/
		OutputBufferedStream(IByteWriterWithPosition* inTargetWriter,LongBufferSizeType inBufferSize = DEFAULT_BUFFER_SIZE);
